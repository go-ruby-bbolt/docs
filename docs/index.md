# go-ruby-bbolt documentation

**Idiomatic Ruby-style key/value store (buckets, ACID transactions, cursors) over go.etcd.io/bbolt — pure-Go, CGO=0, for the Ruby/rbgo ecosystem.**

`go-ruby-bbolt/bbolt` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `bbolt`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-bbolt/bbolt`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `bbolt`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`bbolt`](https://github.com/go-ruby-bbolt/bbolt) | the library — Ruby's `bbolt` in pure Go |
| [`docs`](https://github.com/go-ruby-bbolt/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-bbolt.github.io`](https://github.com/go-ruby-bbolt/go-ruby-bbolt.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-bbolt/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-bbolt/bbolt](https://github.com/go-ruby-bbolt/bbolt).
