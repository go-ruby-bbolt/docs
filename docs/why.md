...
`go-ruby-bbolt/bbolt` reimplements Ruby's `bbolt` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-bbolt/bbolt` directly, with no Ruby runtime;
