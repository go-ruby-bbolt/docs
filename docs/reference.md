...
The public API lives at the module root (`github.com/go-ruby-bbolt/bbolt`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `bbolt`, while the surface follows
...
```go
import "github.com/go-ruby-bbolt/bbolt"
```
...
- **[pkg.go.dev/github.com/go-ruby-bbolt/bbolt](https://pkg.go.dev/github.com/go-ruby-bbolt/bbolt)**

The module's [README](https://github.com/go-ruby-bbolt/bbolt#readme) carries worked
